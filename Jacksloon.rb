...
def kobiconn(x,y)
 _kobiconn(x,y,0.17) #was 0.367/2
end
 def kobiside(x,y)
 nowchub = (0.367/2)
 ...
 #box(x,y-nowchub,x+0.75,y+nowchub,0,-0.433,4)#june23 made 433 back to 4
...
def adamusb(x,y)
 ...
 def kyconsterupsidedown(x,y)
  _kyconsterupsidedown(x,y,0.5)
end
 def _kyconster(x,y,w)
  nowchub = (0.266/2) #kyconSHAFT
